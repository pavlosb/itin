        ...
        <div class="col-12">
            <table class="table table-striped table-sm">
                ...
                <?php foreach ($inspections as $insp): ?>
                    ...
                    <td class="text-center"><?php echo ($insp->status_inspection > 0 ? '<i class="fal fa-eye text-secondary"></i>' : '<a href="'.base_url().'inspection/inspection_edit?id='.$insp->id_inspection.'"><i class="fal fa-edit text-secondary"></i></a>') ?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
